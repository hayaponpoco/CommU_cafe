...
class RobotTools(object):
    ...
    def make_beat_motion(self, duration_seconds:float, speed=1.0):
        DEFAULT_ARM_SERVO_MAP = dict(R_SHOU_R=0,L_SHOU_R=0,R_SHOU_P=-43, L_SHOU_P=43)
        BEAT_ARM_SERVO_MAP_LIST = (
            dict(R_SHOU_R=8, R_SHOU_P=31, L_SHOU_R=-1, L_SHOU_P=-3),
            dict(R_SHOU_R=2, R_SHOU_P=-30, L_SHOU_R=-2, L_SHOU_P=-36),
            dict(R_SHOU_R=7, R_SHOU_P=-14, L_SHOU_R=-8, L_SHOU_P=34),
            dict(R_SHOU_R=8, R_SHOU_P=26, L_SHOU_R=-9, L_SHOU_P=9),
            dict(R_SHOU_R=3, R_SHOU_P=-13, L_SHOU_R=-4, L_SHOU_P=-11),
            dict(R_SHOU_R=8, R_SHOU_P=33, L_SHOU_R=-3, L_SHOU_P=-4)
        )
        def __choose(prev):
            while True:
